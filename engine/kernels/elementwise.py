...
Rows are B*T draft-tree nodes; hidden inputs are contiguous [B*T,H], packed
projections are [B*T,6144] and [B*T,19456]. Cache views have logical
[B,8,L,128] shape and arbitrary strides. base is an int64 [B] CUDA tensor
holding each sequence's root slot. No wrapper synchronizes the host.
"""
